      ...
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul>
              <li className="mb-4"> KaKaoTalke API</li>
              <li className="mb-4"> Instagram API</li>
              <li className="mb-4"> FaceBook API</li>
            </ul>
          </div>
        </div>
        {/*------------------- SNS Links */}
        <div className="SNS link flex justify-center gap-x-6">
          <a href="#">
            <svg
              width="20"
              height="20"
